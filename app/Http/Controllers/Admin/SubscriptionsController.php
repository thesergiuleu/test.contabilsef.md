...
class SubscriptionsController extends VoyagerBaseController
{
    // POST BR(E)AD
    public function update(Request $request, $id)
    {
        ...
        $subscription = $this->insertUpdateData($request, $slug, $dataType->editRows, $data);

        if ($request->has('notify') && $request->get('notify') == 1) {
            Notification::send($subscription->user, new NotifyUserAboutSubscriptionStartedNotification($subscription));
        }
    ...
    public function store(Request $request)
    {
        ...
        Notification::send($data->user, new SubscriptionNotification($data));
