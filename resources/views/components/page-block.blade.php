<div class="position-post">
    ...
    @if($component['data']->slug == \App\Page::SUBSCRIBE)
        <div style="text-align: center">
            @if(auth()->user())
                <a href="#" onclick="openSubscribeModal('{{ route("page.view", \App\Page::TERMS_AND_CONDITIONS_REVISTA) }}', 'Revista electronică ”Contabilsef.md”', 'revista')" class="myBtnRed">Abonează-te</a>
            @else
    ...
    @if($component['data']->slug == \App\Page::CONSULTANT_SNC)
        <div style="text-align: center">
            @if(auth()->user())
                <a href="#" onclick="openSubscribeModal('{{ route("page.view", \App\Page::TERMS_AND_CONDITIONS_SNC) }}', 'Consultant SNC', 'consultant')" class="myBtnRed">Abonează-te</a>
            @else
                <a href="#" class="autentific myBtnRed">Abonează-te</a>
            @endif
        </div>
