...
<head>
    ...
    <title>@yield('title', setting('site.name', 'Contabil Șef'))</title>
    ...
    <style>
        body {
            background-image:url('{{ Voyager::image( Voyager::setting("site.bg_image"), asset("assets/imgs/auth_image.jpg") ) }}');
            background-color: {{ Voyager::setting("site.bg_color", "#FFFFFF" ) }};
        }
