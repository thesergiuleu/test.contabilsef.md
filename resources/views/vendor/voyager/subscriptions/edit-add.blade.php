                ...
                <div class="panel panel-bordered">
                    ...
                    <!-- CSRF TOKEN -->
                        ...
                        <div class="panel-footer">
                            ...
                            @if($edit)
                                <button type="button" onclick="changeNotifyValueAdnSubmitForm()" class="btn btn-secondary"> Salveaza si notifica</button>
                            @endif
                        </div>
                    </form>
...
@section('javascript')
    <script>
        ...
        function changeNotifyValueAdnSubmitForm() {
            const form = $('.form-edit-add');
            $('[name=\'notify\']').val('1');
            form.submit();
        }
