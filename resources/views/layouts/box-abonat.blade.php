<div class="box-abounat">
    @if($check)
            <p style="font-weight: bold; font-size: 20px">Această informație este destinată pentru abonații: <a href="{{ route('profile') }}" style="font-weight: bold; font-size: 20px;text-decoration: underline; color: black !important;">{{ $item->getPostSubscriptionServices() }}</a></p>
            <div style="display: flex;align-items: center;justify-content: center;">
                ...
                <ul style="width: 60%;">
                    ...
                    <li style="font-weight: 500">Achitați imediat cu cardul bancar sau prin transfer factura de plată primită pe poșta electronică</li>
                    <li style="font-weight: 500">Odată cu încasarea plății primiți acces la conținutul revistei și beneficiile oferite</li>
                </ul>
            </div>
    @else
